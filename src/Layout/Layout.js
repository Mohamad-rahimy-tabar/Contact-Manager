  ...
  return (
    <div className="h-screen w-screen flex flex-col gap-4 items-center fixed top-0 left-0 ">
      <div className="container p-2 w-full  h-[calc(100%-60px)] md:h-full">
        <ToastContainer
          toastClassName={({ type }) => contextClass[type || "default"] + " relative flex flex-nowrap p-2 md:w-[2000px] w-[210px]  rounded-md w-auto justify-between overflow-hidden cursor-pointer"}
